 ...
 */
public class HotDeployJarClassLoader extends URLClassLoader {

    private JarURLConnection cachedJarFile = null;

    public HotDeployJarClassLoader() {
    ...
    private static ClassLoader findParentClassLoader() {
        ClassLoader parent = HotDeployJarClassLoader.class.getClassLoader();
        if (parent == null) {
            parent = HotDeployJarClassLoader.class.getClassLoader();
        }
        if (parent == null) {
